...
- Estudiar la **evolución de una variable a lo largo del tiempo** (o espacio). Esto es equivalente a evaluar el efecto que tiene el tiempo (o espacio) sobre esta variable.
